...
\begin{table}[ht]
    \centering
    \caption{Kompetencje PPM według ról}
    \label{tab:ppm_competencies}
    \adjustbox{max width=\textwidth}{ % Dostosowuje tabelę do szerokości strony
    \begin{tabular}{|l|C|C|C|C|C|C|}
    \hline
    \rowcolor{lightgray!50}
    & \textbf{A1L} & \textbf{Frog} & \textbf{MgTs} & \textbf{Change MgTs} & \textbf{Project MgTs} & \textbf{Support} \\
    \hline
    \textbf{1} & Planowanie i organizacja & Przywództwo & Planowanie i organizacja & Planowanie i organizacja & Planowanie i organizacja & Planowanie i organizacja \\
    \hline
    \textbf{2} & Umiejętności komunikacyjne & Planowanie i organizacja & Umiejętności komunikacyjne & Umiejętności komunikacyjne & Umiejętności komunikacyjne & Umiejętności komunikacyjne \\
    \hline
    \textbf{3} & Przywództwo & Zarządzanie relacjami & Elastyczność & Zarządzanie relacjami & Elastyczność & Techniczne \\
    \hline
    \textbf{4} & Zarządzanie relacjami & Umiejętności komunikacyjne & Zarządzanie relacjami & Elastyczność & Techniczne & Techniczne \\
    \hline
    \textbf{5} & Elastyczność & Świadomość komercyjna & Przywództwo & Przywództwo & Proaktywność/Inicjatywa & Techniczne \\
    \hline
    \textbf{6} & Proaktywność/Inicjatywa & Wpływanie & Wpływanie & Techniczne & Praca zespołowa & Techniczne \\
    \hline
    \textbf{7} & Techniczne – Metody/Narzędzia & Elastyczność & Proaktywność/Inicjatywa & Podejmowanie decyzji & Zarządzanie relacjami & Techniczne \\
    \hline
    \textbf{8} & Wpływanie & Podejmowanie decyzji & Techniczne & Praca zespołowa & Wpływanie & Techniczne \\
    \hline
    \textbf{9} & Podejmowanie decyzji & Proaktywność/Inicjatywa & Podejmowanie decyzji & Proaktywność/Inicjatywa & Przywództwo & Techniczne \\
    \hline
    \textbf{10} & Praca zespołowa & Techniczne & Świadomość organizacyjna & Wpływanie & Dbałość o dokładność & Techniczne \\
    \hline
    \textbf{11} & Świadomość komercyjna & Praca zespołowa & Świadomość komercyjna & Świadomość komercyjna & Świadomość organizacyjna & Techniczne \\
    \hline
    \textbf{12} & Dbałość o dokładność & Świadomość organizacyjna & Praca zespołowa & Dbałość o dokładność & Podejmowanie decyzji & Techniczne \\
    \hline
    \textbf{13} & Świadomość organizacyjna & Dbałość o dokładność & Dbałość o dokładność & Świadomość organizacyjna & Świadomość komercyjna & Techniczne \\
    \hline
    \end{tabular}}
    \end{table}
