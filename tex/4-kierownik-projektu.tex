...
\begin{table}
  ...
  \end{table}
    ...
    \begin{table}[ht!]
        ...
        \begin{tabular}{>{\raggedright\arraybackslash}p{0.75cm} >{\raggedright\arraybackslash}p{4.5cm} >{\centering\arraybackslash}p{1.2cm} >{\centering\arraybackslash}p{1.2cm} >{\raggedright\arraybackslash}p{5cm}}
        \toprule
        \textbf{Poz.} & \textbf{Kompetencja} & \textbf{Liczba} & \textbf{\%} & \textbf{Opis/Przykład} \\
        \midrule
