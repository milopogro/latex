...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{img/ryzyka1.png}
    \caption{Gemino, Reich i Sauer, „A Temporal Model of Information Technology Project Performance”}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{img/ryzyka2.png}
    \caption{Gemino, Reich i Sauer, „A Temporal Model of Information Technology Project Performance”}
\end{figure}
