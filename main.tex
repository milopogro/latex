...
\input{tex/3-specyfika-projektow-informatycznych}                            % na nowe wersje, a cały tekst pracy pozostaje nienaruszony.
\input{tex/4-kierownik-projektu} % wystarczy podmienić swoje pliki main.tex i eiti-thesis.cls
\input{tex/5-ankieta}
